...
#define BASE_SEG_HEIGHT     20    /* base height (y) of each bar */
...

{
    ...
    lv_obj_set_style_text_font(lbl_title, &eurostile_extended_bold_20, 0);
    ...
    int f_x = start_x + (seg_w / 2) + LABEL_INSET_X - (lv_obj_get_width(lbl_f) / 2 + 30);
    ...
    int e_y = (bar_baseline_y - seg_h[SEG_COUNT - 1]) - LABEL_OFF_Y - (lv_obj_get_height(lbl_e) / 2 + 20) - LABEL_RAISE_Y;
    ...
    */
    ...
    lv_obj_set_style_text_font(label_pct, &eurostile_extended_bold_20, 0);
