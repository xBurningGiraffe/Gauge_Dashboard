...
#include "eurostile_fonts.h" /* Contains eurostile_extended_black_14, etc. */
...
void create_wmi_flow_gauge(lv_obj_t *parent)
{
    ...
    */
    ...
    lv_obj_set_style_text_font(scale, &eurostile_extended_black_16, LV_PART_INDICATOR);
    ...
    /* 4) “psi” label under 25 psi tick */
    {
        ...
        lv_obj_set_style_text_font(psi_lbl, &eurostile_extended_black_14, 0);
        ...
        int y = (int)(cy + r * sinf(angle_rad)) - (lv_obj_get_height(psi_lbl) / 2) + PSI_Y_OFF + 46;
    ...
    /* 5) “WMI FLOW” caption at the bottom */
    {
        ...
        lv_obj_set_style_text_font(cap, &eurostile_extended_black_20, 0);
